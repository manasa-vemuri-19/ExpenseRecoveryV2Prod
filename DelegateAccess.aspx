...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td class="style8">
            ...
            &nbsp;&nbsp;&nbsp;
            <br />
             <asp:CheckBoxList ID="chkPracticeLineList" runat="server" CssClass="FormText" RepeatDirection="Horizontal"  AutoPostBack="true"
                             BorderWidth="0" OnSelectedIndexChanged="chkPracticeLineList_SelectedIndexChanged">
