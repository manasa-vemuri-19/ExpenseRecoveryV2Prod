<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExpenseRecovery.aspx.cs"
    Inherits="ExpenseCopy" %>
...
<head id="Head1" runat="server">
    ...
    <script src="Scripts/app/DB_12.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        function tab(value) {
            ...
            if (value == "Access") {
                ...
                $("#iframe3").attr("src", "ExpenseRecoverySummaryweb.aspx");
            }
    ...
    <div style="margin-top: 5px; margin-left: 3px">
        ...
        <div class="tab-content">
            <div id="home" class="tab-pane fade in active">
                <iframe id="iframe3" runat="server" style="border: 0px; height: 600px; width: 100%">
                </iframe>
            </div>
